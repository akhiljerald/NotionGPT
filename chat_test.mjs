...
if (output.length > 2000)
{
    ...
    while(len>0)
    {
        ...
        else if (len>=2000 && appendFlag)
        {
            ...
            appendBlockToPage(s.substring(0,2000), new_page_id).then(response => {
        ...
        else 
        {
            if (appendFlag)
            {
                ...
                appendBlockToPage(s.substring(0,len), new_page_id).then(response => {
                    console.log(response);
                });
                len = 0;
